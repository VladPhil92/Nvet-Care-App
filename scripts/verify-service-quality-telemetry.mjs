...
includes(service, 'appointment.createdAt -> confirmedAt', 'Telemetry semantics')
...
console.log(
  'Phase 26 service-quality telemetry contract valid: aggregate read-only metrics use durable lifecycle timestamps, preserve market/privacy boundaries, distinguish insufficient data, and cannot authorize launch.',
)
