...
includes(service, 'this.betaActivation.getPrerequisites()', 'Launch service')
...
includes(service, 'ACTIVATION_PREREQUISITE_', 'Launch service')
includes(service, 'betaMarketConfiguredForCartagena', 'Launch service')
...
console.log('Cartagena launch readiness contract valid: GO/HOLD/PAUSE cockpit is read-only, fail-closed, booking-prerequisite aware and preserves strict VET supply as the launch source of truth.')
