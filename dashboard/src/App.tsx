...
import VetInvitationOpsPage from './pages/VetInvitationOpsPage'
...
import ServiceQualityPage from './pages/ServiceQualityPage'
  ...
  return (
    ...
    >
      ...
      >
        ...
        {page === 'service-quality' && <ServiceQualityPage />}
